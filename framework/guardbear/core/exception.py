...
from guardbear.core.cluster import __version__
from guardbear.core.common import AGENT_NAME_LEN_LIMIT, MAX_SOCKET_BUFFER_SIZE, GUARDBEAR_SERVER_YML
...
class GuardBearException(Exception):
    """GuardBear Exception object."""
    ...
    ERRORS = {
        ...
        1006: {
            ...
            'remediation': 'Please, check if path to file/directory is correct and `guardbear` '
        ...
        1101: {
            ...
            'remediation': 'Run `GUARDBEAR_PATH/bin/guardbear-logtest -t` to check your configuration',
        },
        1103: {
            'message': 'Invalid field in section',
            'remediation': f'Please, visit the official documentation (https://documentation.guardbear.com/'
        ...
        1106: {
            ...
            f'You can visit the official documentation (https://documentation.guardbear.com/'
            f'{DOCU_VERSION}/user-manual/reference/ossec-conf/index.html) '
            'to get more information about configuration sections',
        },
        ...
        1119: "Directory '/tmp' needs read, write & execution permission for 'guardbear' user",
        1121: {
        ...
        1124: {
            ...
            f'exception: https://documentation.guardbear.com/{DOCU_VERSION}/user-manual/api/'
        ...
        1127: {
            ...
            'in the API settings: '
            f'https://documentation.guardbear.com/{DOCU_VERSION}/user-manual/api/configuration.html',
        },
        ...
        1129: {
            ...
            f'https://documentation.guardbear.com/{DOCU_VERSION}/user-manual/api/'
        ...
        1307: {
            ...
            'contact us at [official repository](https://github.com/guardbear/guardbear/issues)',
        },
        # Utils: 1400 - 1499
        1400: 'Invalid offset',
        1401: 'Invalid limit',
        ...
        1707: {
            ...
            f'https://documentation.guardbear.com/{DOCU_VERSION}/user-manual/registering/index.html and '
            f'https://documentation.guardbear.com/{DOCU_VERSION}/user-manual/agents/agent-connection.'
        ...
        1728: {
            ...
            'remediation': f'Valid types are `master` and `worker`. Please, visit https://documentation.guardbear.com/'
        ...
        1730: {
            ...
            f'`cluster_control -l` (https://documentation.guardbear.com/{DOCU_VERSION}/user-manual/'
        ...
        1734: {
            ...
            f'https://documentation.guardbear.com/{DOCU_VERSION}/user-manual/agents/grouping-agents.html',
        },
        1735: {
        ...
        2703: {'message': 'GuardBear comms API SSL error. Please, ensure the configuration is correct'},
        ...
        3024: 'Length of command exceeds limit defined in guardbear.cluster.common.Handler.cmd_len.',
        ...
        3028: {
            ...
            'remediation': f'Check and fix [worker names](https://documentation.guardbear.com/{DOCU_VERSION}/'
            f'user-manual/reference/ossec-conf/cluster.html#node-name)'
            ' and restart the `guardbear-manager` service.',
        },
        3029: {
            'message': 'Connected worker with same name as the master',
            'remediation': f'Check and fix the [worker name](https://documentation.guardbear.com/{DOCU_VERSION}/'
            f'user-manual/reference/ossec-conf/cluster.html#node-name)'
            ' and restart the `guardbear-manager` service in the node',
        },
        3031: {
            'message': 'Worker and master versions are not the same',
            'remediation': f'[Update](https://documentation.guardbear.com/{DOCU_VERSION}/upgrade-guide/index.html)'
        ...
        4000: {
            ...
            f'guardbear.com/{DOCU_VERSION}/user-manual/api/rbac/configuration.html',
        },
        ...
        4019: {
            ...
            f'/documentation.guardbear.com/{DOCU_VERSION}/user-manual/api/rbac/configuration.html',
        },
        ...
        5008: {
            ...
            'remediation': 'You can delete this user with the administrator user (guardbear) or '
        ...
        6001: {
            ...
            'remediation': f'This limit can be changed in the {GUARDBEAR_SERVER_YML} file',
        },
        6002: {'message': 'The body type is not the one specified in the content-type'},
        6003: {
            'message': 'Error trying to load the JWT secret',
            'remediation': 'Make sure you have the right permissions: GUARDBEAR_PATH/api/configuration/security/jwt_secret',
        },
        6004: {
            'message': 'The current user does not have authentication enabled through authorization context',
            'remediation': f'You can enable it using the following endpoint: https://documentation.guardbear.com/'
    ...
    def __init__(
        ...
        """Create a GuardBearException object.
        ...
        dapi_errors : dict
            Dictionary with details about node and logfile. I.e.: {'master-node': {'error': 'GuardBear Internal error',
    ...
    def __eq__(self, other):
        if not isinstance(other, GuardBearException):
    ...
    def __or__(self, other):
        if isinstance(other, GuardBearException):
    ...
    def from_dict(cls, dct: dict):
        """Convert a dictionary into a GuardBearException object.
...
class GuardBearInternalError(GuardBearException):
...
class GuardBearHAPHelperError(GuardBearClusterError):
...
class GuardBearError(GuardBearException):
    ...
    def __init__(
        ...
        """Create a GuardBearError exception.
    ...
    def __or__(self, other):
        result: GuardBearError = super().__or__(other)
        if isinstance(result, GuardBearError):
...
class GuardBearPermissionError(GuardBearError):
...
class GuardBearResourceNotFound(GuardBearError):
...
class GuardBearTooManyRequests(GuardBearError):
...
class GuardBearNotAcceptable(GuardBearError):
