...
class GuardBearLogger:
    """Define attributes of a Python GuardBear daemon's logger."""

    def __init__(
        self,
        debug_level: [int, str],
        logger_name: str = 'guardbear',
...
class CLIFilter(logging.Filter):
    ...
    messages_to_avoid = ['GuardBear Internal Error', 'GuardBearInternalError']
