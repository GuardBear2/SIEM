...
class GuardBearAgent:
    """Tools to handle GuardBear agents connections."""
...
class GuardBearDAPI:
    """Class to call GuardBear DAPI functions."""
    ...
    def _get_logger(tag: str) -> logging.Logger:
        ...
        """
        logger = logging.getLogger('guardbear').getChild('GuardBearDAPI')
