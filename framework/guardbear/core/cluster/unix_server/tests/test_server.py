...
import uvicorn
from guardbear.core.cluster.unix_server.config import get_config
from guardbear.core.cluster.unix_server.server import common, get_log_config, start_unix_server
...
@patch('guardbear.core.cluster.unix_server.server.FastAPI')
@patch('guardbear.core.cluster.unix_server.server.APIRouter')
@patch('guardbear.core.cluster.unix_server.server.Thread')
