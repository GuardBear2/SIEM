...
from guardbear.core.indexer.models.commands import Status
...
async def get_orders(logger: GuardBearLogger):
    ...
    while True:
        ...
        except (httpx.ConnectError, httpx.TimeoutException, GuardBearError, GuardBearIndexerError) as e:
