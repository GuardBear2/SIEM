...
from framework.guardbear.core.authentication import (
    derive_public_key,
    get_keypair,
    load_jwt_keys,
)
...
@patch('guardbear.core.authentication.CentralizedConfig.get_server_config')
...
def test_load_jwt_keys_already_configured():
    ...
    with (
        patch(
            'guardbear.core.config.client.CentralizedConfig.get_server_config',
            return_value=mock_config,
        ) as mock_get_config,
        patch('framework.guardbear.core.authentication.derive_public_key') as mock_generate,
    ):
...
def test_load_jwt_keys_generate_when_missing():
    ...
    with (
        ...
        patch(
            'framework.guardbear.core.authentication.derive_public_key',
