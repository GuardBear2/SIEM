...
class ManagementAPIIntervals(GuardBearConfigBaseModel):
...
class CorsConfig(GuardBearConfigBaseModel):
...
class AccessConfig(GuardBearConfigBaseModel):
...
class ManagementAPIConfig(GuardBearConfigBaseModel):
