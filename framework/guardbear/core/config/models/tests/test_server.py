...
from guardbear.core.config.models.server import (
    DEFAULT_CTI_URL,
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({'update_check': False, 'url': 'www.guardbear.com'}, {'update_check': False, 'url': 'www.guardbear.com'}),
    ],
)
...
@patch('guardbear.core.config.models.base.ValidateFilePathMixin._validate_file_path')
