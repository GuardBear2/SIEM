...
from guardbear.core.config.models.logging import EngineLoggingConfig


class EngineClientConfig(GuardBearConfigBaseModel):
    """Configuration for the Engine client.

    Parameters
    ----------
    api_socket_path : FilePath
        The path to the API socket. Default: "/run/guardbear-server/engine.socket".
    retries : PositiveInt
...
class EngineConfig(GuardBearConfigBaseModel):
