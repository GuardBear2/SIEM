...
from guardbear.core.indexer.models.events import Agent, AgentMetadata, Header, Module, get_module_index_name

from framework.guardbear.core.batcher.mux_demux import Item, MuxDemuxManager, MuxDemuxQueue, Packet
...
@patch('framework.guardbear.core.batcher.mux_demux.SyncManager')
@patch('framework.guardbear.core.batcher.mux_demux.MuxDemuxRunner')
