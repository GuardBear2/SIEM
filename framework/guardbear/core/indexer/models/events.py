...
from guardbear.core.indexer.models.agent import Host as AgentHost

FIM_INDEX = 'guardbear-states-fim'
INVENTORY_HARDWARE_INDEX = 'guardbear-states-inventory-hardware'
INVENTORY_HOTFIXES_INDEX = 'guardbear-states-inventory-hotfixes'
INVENTORY_NETWORKS_INDEX = 'guardbear-states-inventory-networks'
INVENTORY_PACKAGES_INDEX = 'guardbear-states-inventory-packages'
INVENTORY_PORTS_INDEX = 'guardbear-states-inventory-ports'
INVENTORY_PROCESSES_INDEX = 'guardbear-states-inventory-processes'
INVENTORY_SYSTEM_INDEX = 'guardbear-states-inventory-system'
SCA_INDEX = 'guardbear-states-sca'
VULNERABILITY_INDEX = 'guardbear-states-vulnerabilities'
...
def get_module_index_name(module: Module, collector: Optional[str] = None) -> str:
    ...
    if module == Module.INVENTORY:
        ...
        if collector not in collectors:
            ...
            raise GuardBearError(1763, extra_message=extra_info)
    ...
    try:
        ...
        raise GuardBearError(1765, extra_message=extra_info)
