...
from guardbear.core.indexer.base import BaseIndex, remove_empty_values
from guardbear.core.indexer.models.agent import Agent
...
def test_remove_empty_values_asdict():
    ...
    agent = Agent(id='test', name='guardbear')
    expected = {'id': 'test', 'name': 'guardbear'}
