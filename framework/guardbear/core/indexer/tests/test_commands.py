...
from guardbear.core.indexer.base import POST_METHOD, IndexerKey
from guardbear.core.indexer.commands import (
    COMMAND_KEY,
    COMMAND_USER_NAME,
    CommandsManager,
...
from guardbear.core.indexer.models.commands import (
    Action,
    Command,
...
class TestCommandsManager:
    ...
    async def test_create_ko(self, manager_instance: CommandsManager, client_mock: mock.AsyncMock, exc):
        ...
        with pytest.raises(GuardBearError, match='.*1761.*'):
    ...
    async def test_get_commands_ko(self, manager_instance: CommandsManager, client_mock: mock.AsyncMock, exc):
        ...
        with pytest.raises(GuardBearError, match=r'1761'):
