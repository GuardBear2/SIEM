...
from guardbear.core.exception import GuardBearError, GuardBearException, GuardBearInternalError
from guardbear.core.wdb import GuardBearDBConnection

"""
GuardBear HIDS Python package
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
GuardBear is a python package to manage OSSEC.
...
class GuardBear:
    ...
    def __init__(self):
        ...
        self.type = 'server'
        self.path = common.GUARDBEAR_SHARE
