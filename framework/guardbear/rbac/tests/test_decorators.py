...
from guardbear.rbac.tests.utils import init_db
    ...
    with patch('guardbear.core.common.guardbear_uid'), patch('guardbear.core.common.guardbear_gid'):
        with patch('sqlalchemy.create_engine', return_value=create_engine('sqlite://')):
            with patch('shutil.chown'), patch('os.chmod'):
                import guardbear.rbac.decorators as decorator
...
async def test_expose_resources(
    ...
    with patch('guardbear.rbac.decorators._expand_resource', side_effect=mock_expand_resource):
        ...
        try:
            ...
            assert output == function_params.get('call_func', True) or isinstance(output, AffectedItemsGuardBearResult)
