...
# Database support for GuardBear HIDS.
# Copyright (C) 2015, GuardBear Inc. <info@guardbear.com>
# September 28, 2018.
...
def _print_help():
    print('''
    FIM database upgrade tool for GuardBear
...
if __name__ == '__main__':
    ...
    if _verbose:
        logging.debug("Connected to GuardBearDB socket ({0})".format(_wdb_socket))
