...
title: Release [GUARDBEAR VERSION] - [STAGE] - System tests
...
These requirements should be requested to the @guardbear/devel-devops team via https://github.com/guardbear/internal-devel-requests.

For further information, check https://github.com/guardbear/guardbear-qa/tree/master/tests/system/README.md
