# Copyright (C) 2015-2023, GuardBear Inc.
...
from guardbear_testing.modules.monitord import configuration as monitord_config
...
GUARDBEAR_MODULES_DEBUG = 'guardbear_modules.debug'
...
local_internal_options = {GUARDBEAR_MODULES_DEBUG: '2',
