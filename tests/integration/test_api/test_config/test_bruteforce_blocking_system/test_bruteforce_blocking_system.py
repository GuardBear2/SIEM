...
brief: These tests will check if the IP blocking feature of the API handled by the 'guardbear-apid' daemon
       is working properly. The GuardBear API is an open source 'RESTful' API that allows for interaction
...
from guardbear_testing.modules.api.patterns import API_LOGIN_ERROR_MSG
