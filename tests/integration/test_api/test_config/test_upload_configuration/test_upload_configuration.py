...
def test_upload_configuration(test_configuration, test_metadata, backup_guardbear_configuration, add_configuration,
    ...
    parameters:
        ...
        - backup_guardbear_configuration:
            type: fixture
            brief: Save the initial guardbear configuration and restore it after the test.
        - add_configuration:
            type: fixture
