# Copyright (C) 2015-2021, GuardBear Inc.
...
from . import GUARDBEAR_PYTHON_INTERPRETER_PATH, MOCK_SERVER_PATH, MOCK_SERVER_IMAGE, MOCK_SERVER_CONTAINER
...
def disable_ssl_verification():
    """Modify guardbear/core/utils.py to avoid SSL certificate verification."""
    file_path = Path(GUARDBEAR_PYTHON_INTERPRETER_PATH, '/guardbear/core/utils.py')
