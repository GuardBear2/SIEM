...
brief: These tests will check if the 'rbac_mode' (Role-Based Access Control) setting of the API
       ...
       'whitelist mode' and 'blacklist mode'. The GuardBear API is an open source 'RESTful' API
...
references:
    ...
    - https://documentation.guardbear.com/current/user-manual/api/configuration.html#rbac-mode
