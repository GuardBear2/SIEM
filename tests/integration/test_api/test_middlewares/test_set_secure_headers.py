...
brief: These tests will check if the set_secure_headers middleware of the API handled by the 'guardbear-apid' daemon is
       working properly. The GuardBear API is an open source 'RESTful' API that allows for interaction with the GuardBear
...
from guardbear_testing.constants.api import AGENTS_ROUTE, CONFIGURATION_TYPES
