    ...
    for agent_id in agents_list:
        ...
        while tries < 80:
            try:
                ...
                command = f'docker exec env-guardbear-agent{int(agent_id)}-1 grep agentd /var/ossec/logs/ossec.log'
            ...
            raise ProcessLookupError('The guardbear-agentd daemon was not started after requesting the restart')
        ...
        try:
            ...
            output = (
                subprocess.check_output(
                    f'docker exec env-guardbear-master-1 /var/ossec/framework/python/bin/python3 '
