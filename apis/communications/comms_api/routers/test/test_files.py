...
@pytest.mark.parametrize(
    ...
    [
        (GuardBearCommsAPIError(2704), 'Invalid file name, it must not be a directory', 2704),
        (GuardBearCommsAPIError(2705), 'Invalid file name, it must not contain directories', 2705),
