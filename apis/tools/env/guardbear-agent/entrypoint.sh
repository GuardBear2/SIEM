...
MANAGER_URL="https://guardbear-manager:55000"
...
# Enroll agent
SPDLOG_LEVEL=TRACE /usr/share/guardbear-agent/bin/guardbear-agent --enroll-agent --enroll-url $NGINX_URL --user $USER --password $PASSWORD --verification-mode none

# Run agent
SPDLOG_LEVEL=TRACE /usr/share/guardbear-agent/bin/guardbear-agent
