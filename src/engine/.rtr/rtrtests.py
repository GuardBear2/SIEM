...
def unittests(params):
    """ Step that runs the unit tests. It also creates the required folders for GuardBear sockets.
...
def valgrind(params):
    """ Runs valgrind over every UT of the project. It also creates the required folders for GuardBear sockets.
