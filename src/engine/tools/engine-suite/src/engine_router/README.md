...
The `engine-router` tool is a command-line interface that allows you to manage routes in the GuardBear engine. It provides the ability to list, create, update, and delete routes. The tool is part of the `engine-suite` package.
