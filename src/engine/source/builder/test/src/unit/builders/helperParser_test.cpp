...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Values(
        ...
        TermT(R"(hp($guardbear.queue) )", makeSuccess<HelperToken>({"hp", Reference("guardbear.queue")}, 16)),
        TermT(R"(hp($guardbear.queue) ())", makeSuccess<HelperToken>({"hp", Reference("guardbear.queue")}, 16)),
        TermT(R"(hp($guardbear.queue)==())", makeSuccess<HelperToken>({"hp", Reference("guardbear.queue")}, 16)),
        TermT(R"(hp($guardbear.queue) AND)", makeSuccess<HelperToken>({"hp", Reference("guardbear.queue")}, 16)),
        TermT(R"(hp($guardbear.queue)==)", makeSuccess<HelperToken>({"hp", Reference("guardbear.queue")}, 16)),
        TermT(R"(hp($guardbear.queue)!!)", makeSuccess<HelperToken>({"hp", Reference("guardbear.queue")}, 16)),
        TermT(R"(hp($guardbear.queue)>)", makeSuccess<HelperToken>({"hp", Reference("guardbear.queue")}, 16)),
        TermT(R"(hp($guardbear.queue, ,\ \,) )",
              makeSuccess<HelperToken>({"hp", Reference("guardbear.queue"), {val(), val(R"(" ,")")}}, 23)),
        TermT(R"(hp($guardbear.queue, ,\ \,) ())",
              makeSuccess<HelperToken>({"hp", Reference("guardbear.queue"), {val(), val(R"(" ,")")}}, 23)),
        TermT(R"(hp($guardbear.queue, ,\ \,)==())",
              makeSuccess<HelperToken>({"hp", Reference("guardbear.queue"), {val(), val(R"(" ,")")}}, 23)),
        TermT(R"(hp($guardbear.queue, ,\ \,) AND)",
              makeSuccess<HelperToken>({"hp", Reference("guardbear.queue"), {val(), val(R"(" ,")")}}, 23)),
        TermT(R"(hp($guardbear.queue, ,\ \,)==)",
              makeSuccess<HelperToken>({"hp", Reference("guardbear.queue"), {val(), val(R"(" ,")")}}, 23)),
        TermT(R"(hp($guardbear.queue, ,\ \,)!!)",
