...
#include <base/utils/guardbearProtocol/guardbearRequest.hpp>

class GuardBearRequest_validate : public ::testing::Test
{
protected:
...
class GuardBearRequest_getCommand : public ::testing::Test
{
protected:
    void SetUp() override { logging::testInit(); }
...
class GuardBearRequest_getParameters : public ::testing::Test
{
protected:
    void SetUp() override { logging::testInit(); }
...
class GuardBearRequest_create : public ::testing::Test
{
protected:
    void SetUp() override { logging::testInit(); }
...
class GuardBearResponse : public ::testing::Test
{
protected:
    void SetUp() override { logging::testInit(); }
...
TEST_F(GuardBearRequest_validate, validRequest)
{
    base::utils::guardbearProtocol::GuardBearRequest wrequest {jrequest};
    EXPECT_FALSE(wrequest.error());
    ASSERT_TRUE(wrequest.isValid());
}

TEST_F(GuardBearRequest_validate, invalidVersion)
{
    // Invalid Value
    auto oldVersion {2};
    json::Json jrequest_invalid {jrequest};
    jrequest_invalid.setInt(oldVersion, "/version");
    base::utils::guardbearProtocol::GuardBearRequest wrequest {jrequest_invalid};
    ...
    ASSERT_STREQ(wrequest.error()->c_str(),
                 fmt::format("The request version ({}) is not supported, the supported version is {}",
                             oldVersion,
                             base::utils::guardbearProtocol::GuardBearRequest::SUPPORTED_VERSION)
                     .c_str());
    ASSERT_FALSE(wrequest.isValid());
}

TEST_F(GuardBearRequest_validate, missingVersion)
{
    // Missing field
    auto jrequest_invalid = jrequest;
    jrequest_invalid.erase("/version");
    auto wrequest = base::utils::guardbearProtocol::GuardBearRequest {jrequest_invalid};
    EXPECT_TRUE(wrequest.error());
    ASSERT_FALSE(wrequest.isValid());
    ASSERT_STREQ(wrequest.error()->c_str(), "The request must have a 'version' field containing an integer value");
}

TEST_F(GuardBearRequest_validate, wrongTypeVersion)
{
    // Wrong type
    auto jrequest_invalid = jrequest;
...
TEST_F(GuardBearRequest_validate, invalidCommandType)
{
    // Wrong type
    auto jrequest_invalid = jrequest;
...
TEST_F(GuardBearRequest_validate, missingCommand)
{
    // Missing field
    auto jrequest_invalid = jrequest;
...
TEST_F(GuardBearRequest_validate, invalidParametersType)
{
    // Wrong type
    auto jrequest_invalid = jrequest;
...
TEST_F(GuardBearRequest_validate, missingParameters)
{
    // Missing field
    auto jrequest_invalid = jrequest;
...
TEST_F(GuardBearRequest_validate, invalidOriginType)
{
    // Wrong type
    auto jrequest_invalid = jrequest;
...
TEST_F(GuardBearRequest_validate, missingOrigin)
{
    // Missing field
    auto jrequest_invalid = jrequest;
...
TEST_F(GuardBearRequest_validate, invalidOriginNameType)
{
    // Wrong type
    auto jrequest_invalid = jrequest;
...
TEST_F(GuardBearRequest_validate, missingOriginName)
{
    // Missing field
    auto jrequest_invalid = jrequest;
...
TEST_F(GuardBearRequest_validate, invalidOriginModuleType)
{
    // Wrong type
    auto jrequest_invalid = jrequest;
...
TEST_F(GuardBearRequest_validate, missingOriginModule)
{
    // Missing field
    auto jrequest_invalid = jrequest;
...
TEST_F(GuardBearRequest_validate, rootWrongType)
{
    // Wrong type
...
TEST_F(GuardBearRequest_validate, rootWrongTypeArray)
{
    // Wrong type
...
TEST_F(GuardBearRequest_getCommand, valid)
{
    auto wrequest = base::utils::guardbearProtocol::GuardBearRequest {jrequest};
    ASSERT_TRUE(wrequest.isValid());
    ASSERT_STREQ(wrequest.getCommand().value().c_str(), "test command");
}

TEST_F(GuardBearRequest_getParameters, valid)
{
    auto wrequest = base::utils::guardbearProtocol::GuardBearRequest {jrequest};
    ASSERT_TRUE(wrequest.isValid());
...
TEST_F(GuardBearRequest_getCommand, invalidRequest)
{
    auto jrequest_invalid = jrequest;
...
TEST_F(GuardBearRequest_getParameters, invalidRequest)
{
    auto jrequest_invalid = jrequest;
    jrequest_invalid.setString("{}", "/parameters");
    auto wrequest = base::utils::guardbearProtocol::GuardBearRequest {jrequest_invalid};
...
TEST_F(GuardBearRequest_create, valid_paramObjtype)
{
    auto wrequest = base::utils::guardbearProtocol::GuardBearRequest::create(
...
TEST_F(GuardBearRequest_create, invalid_paramArraytype)
{
    ASSERT_THROW(base::utils::guardbearProtocol::GuardBearRequest::create(
                     "test command",
                     "api",
...
TEST_F(GuardBearRequest_create, invalid_emptyCommand)
{
    ASSERT_THROW(base::utils::guardbearProtocol::GuardBearRequest::create(
